...
- **အသံနှင့် စကားသံမှတ်ချက်**။ ဤရည်ရွယ်ချက်အတွက် Whisper-type မော်ဒယ်များသည် အသုံးများသော ရွေးချယ်စရာ တစ်ခုဖြစ်ပြီး အထွေထွေအသုံးပြုနိုင်ရန် ဖန်တီးထားကာ စကားသံမှတ်ချက်အတွက် ရည်ရွယ်ထားပါသည်။ မတူညီသော အသံများဖြင့် လေ့ကျင့်ထားပြီး ဘာသာစကာမျိုးစုံကို ဖမ်းယူမှတ်သားထားနိုင်ပါသည်။ [Whisper type မော်ဒယ်များအကြောင်း နောက်ထပ်သိရှိရန်](https://platform.openai.com/docs/models/whisper?WT.mc_id=academic-105485-koreyst)။
...
- **စာသားဖန်တီးခြင်း**။ မော်ဒယ်အများစုသည် စာသားဖန်တီးခြင်းအပေါ် လေ့ကျင့်ထားပြီး GPT-3.5 မှ GPT-4 အထိ ရွေးချယ်မှုများစွာ ရှိပါသည်။ ၎င်းတို့သည် မတူညီသော ကုန်ကျစရိတ်များရှိနိင်ပြီး GPT-4 သည် ရေပန်းအစားဆုံးဖြစ်သည်။ စွမ်းဆောင်ရည်နှင့် ကုန်ကျစရိတ်အရ သင့်လိုအပ်ချက်များနှင့် အကောင်းဆုံး ကိုက်ညီသော မော်ဒယ်များကို အကဲဖြတ်ရန် [Azure OpenAI playground](https://oai.azure.com/portal/playground?WT.mc_id=academic-105485-koreyst) ကို ကြည့်ရှုသင့်ပါသည်။

- **Multi-modality**။ input နှင့် output တွင် မတူညီသော ဒေတာ အမျိုးအစားများကို ကိုင်တွယ်လိုပါက [gpt-4 turbo with vision သို့မဟုတ် gpt-4o](https://learn.microsoft.com/azure/ai-services/openai/concepts/models#gpt-4-and-gpt-4-turbo-models?WT.mc_id=academic-105485-koreyst) ကဲ့သို့သော မော်ဒယ်များကို ကြည့်ရှုနိုင်ပါသည် - OpenAI မော်ဒယ်များ၏ နောက်ဆုံးပေါ်ဗားရှင်းများ - ၎င်းတို့သည် သဘာဝ ဘာသာစကား processing နှင့် visual နားလည်မှုကို ပေါင်းစပ်နိုင်ပြီး multi-modal interfaces များမှတဆင့် အပြန်အလှန် ချိတ်ဆက်တုံ့ပြန်မှုများ ပြုလုပ်နိုင်ပါသည်။
