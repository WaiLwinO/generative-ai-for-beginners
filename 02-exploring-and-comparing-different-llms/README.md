...
- **အသံနှင့် စကားသံ ဖမ်းယူမှတ်သားခြင်း**။ ဤရည်ရွယ်ချက်အတွက် Whisper-type မော်ဒယ်များသည် အသုံးများသော ရွေးချယ်စရာ တစ်ခုဖြစ်ပြီး အထွေထွေအသုံးပြုနိုင်ရန် ဖန်တီးထားကာ စကားသံမှတ်ချက်အတွက် ရည်ရွယ်ထားပါသည်။ မတူညီသော အသံများဖြင့် လေ့ကျင့်ထားပြီး ဘာသာစကာမျိုးစုံကို ဖမ်းယူမှတ်သားထားနိုင်ပါသည်။ [Whisper type မော်ဒယ်များအကြောင်း နောက်ထပ်သိရှိရန်](https://platform.openai.com/docs/models/whisper?WT.mc_id=academic-105485-koreyst)။
...
- **စာသားဖန်တီးခြင်း**။ မော်ဒယ်အများစုသည် စာသားဖန်တီးခြင်းအပေါ် လေ့ကျင့်ထားပြီး GPT-3.5 မှ GPT-4 အထိ ရွေးချယ်မှုများစွာ ရှိပါသည်။ ၎င်းတို့သည် မတူညီသော ကုန်ကျစရိတ်များရှိနိင်ပြီး GPT-4 သည် ဈေးအကြီးဆုံးဖြစ်သည်။ စွမ်းဆောင်ရည်နှင့် ကုန်ကျစရိတ်အရ သင့်လိုအပ်ချက်များနှင့် အကောင်းဆုံး ကိုက်ညီသော မော်ဒယ်များကို အကဲဖြတ်ရန် [Azure OpenAI playground](https://oai.azure.com/portal/playground?WT.mc_id=academic-105485-koreyst) ကို ကြည့်ရှုသင့်ပါသည်။

- **Multi-modality**။ input နှင့် output တွင် မတူညီသော ဒေတာ အမျိုးအစားများကို ကိုင်တွယ်လိုပါက [gpt-4 turbo with vision သို့မဟုတ် gpt-4o](https://learn.microsoft.com/azure/ai-services/openai/concepts/models#gpt-4-and-gpt-4-turbo-models?WT.mc_id=academic-105485-koreyst) ကဲ့သို့သော မော်ဒယ်များကို ကြည့်ရှုနိုင်ပါသည် - OpenAI မော်ဒယ်များ၏ နောက်ဆုံးပေါ်ဗားရှင်းများ - ၎င်းတို့သည် သဘာဝ ဘာသာစကား processing နှင့် ရုပ်ပုံများကို နားလည်မှုတို့ ပေါင်းစပ်နိုင်ပြီး multi-modal interfaces များမှတဆင့် အပြန်အလှန် ချိတ်ဆက်တုံ့ပြန်မှုများ ပြုလုပ်နိုင်ပါသည်။

မော်ဒယ်တစ်ခုကို ရွေးချယ်ခြင်းဆိုသည်မှာ အခြေခံ စွမ်းရည်အချို့ကို ရရှိခြင်းဖြစ်သော်လည်း၊ ၎င်းမှာ လုံလောက်မည် မဟုတ်ပါ။ မကြာခဏ သင့်တွင် ကုမ္ပဏီ အတွက် သီးသန့် ဒေတာများ ရှိပြီး LLM ကို ထိုဒေတာများ ပေးရန် လိုအပ်ပါသည်။ ၎င်းကို မည်သို့ ချဉ်းကပ်ရမည်ဆိုတာအတွက် ရွေးချယ်စရာ အမျိုးမျိုး ရှိပါသည်၊ နောက်လာမည့် အပိုင်းများတွင် ပိုမိုရှင်းလင်းသွားပါမည်။
...
- **၎င်းတို့သည် unsupervised learning သို့မဟုတ် self-supervised learning ကို အသုံးပြု၍ လေ့ကျင့်ထားပါသည်**၊ ဆိုလိုသည်မှာ ၎င်းတို့သည် တန်ဖိုးသတ်မှတ်ချက်ပေးထားခြင်းမရှိသော multi-modal ဒေတာများပေါ်တွင် လေ့ကျင့်ထားပြီး ၎င်းတို့၏ လေ့ကျင့်ရေး လုပ်ငန်းစဉ်အတွက် လူသား၏ မှတ်ချက် သို့မဟုတ် သတ်မှတ်ပေးခြင်း မလိုအပ်ပါ။
- **၎င်းတို့သည် အလွန်ကြီးမားသော မော်ဒယ်များဖြစ်ပါသည်**၊ ဘီလီယံနှင့်ချီသော ပေးထားချက် parameters များပေါ်တွင် လေ့ကျင့်ထားသော အလွန်နက်ရှိုင်းသော neural networks များပေါ် အခြေခံထားပါသည်။
- **၎င်းတို့သည် ပုံမှန်အားဖြင့် အခြားမော်ဒယ်များအတွက် 'အခြေခံ' အဖြစ် အလုပ်လုပ်ရန် ရည်ရွယ်သည်**၊ ဆိုလိုသည်မှာ ၎င်းတို့သည် လိုသလို အသေးစိတ် ပြုပြင်ပြောင်းလဲဖန်တီးနိုင်သော အခြားမော်ဒယ်များကို တည်ဆောက်ရန်အတွက် အခြေခံအဖြစ် အသုံးပြုနိုင်ပါသည်။
...
ဤခြားနားချက်ကို နောက်ထပ် ရှင်းလင်းရန်အတွက်၊ ChatGPT ကို ဥပမာအဖြစ် ယူကြည့်ကြပါစို့။ ChatGPT ၏ ပထမ version ကို တည်ဆောက်ရန်အတွက် GPT-3.5 ဟုခေါ်သော အခြေခံ မော်ဒယ်ကို foundation model အဖြစ် သုံးခဲ့သည်။ ဆိုလိုသည်မှာ OpenAI သည် chat-specific ဒေတာအချို့ကို အသုံးပြု၍ chatbots ကဲ့သို့သော စကားပြောဆိုမှုကိစ္စ များတွင် ကောင်းမွန်စွာ စွမ်းဆောင်ရန် အထူးပြုလုပ်ထားသော GPT-3.5 ၏ မွမ်းမံထားသောဗားရှင်း tuned version ကို ဖန်တီးခဲ့ခြင်းဖြစ်သည်။
...
Open-source မော်ဒယ်များသည် အများပြည်သူအတွက် လွတ်လပ်စွာ ရရှိနိုင်ပြီး မည်သူမဆို အသုံးပြုနိုင်သော မော်ဒယ်များဖြစ်ပါသည်။ ၎င်းတို့ကို ဖန်တီးခဲ့သော ကုမ္ပဏီ သို့မဟုတ် သုတေသန community မှ ရရှိနိုင်ပါသည်။ ဤမော်ဒယ်များသည် LLMs တွင် အမျိုးမျိုးသော အသုံးပြုမှု အကြောင်းများအတွက် စစ်ဆေးခြင်း၊ မွမ်းမံခြင်းနှင့် စိတ်ကြိုက်ပြင်ဆင်ခြင်း ပြုလုပ်ရန် ခွင့်ပြုထားပါသည်။ သို့သော် ၎င်းတို့သည် စီးပွားဖြစ် အသုံးပြုမှုအတွက် အမြဲတမ်း အကောင်းဆုံး မဟုတ်ပြီး လိုင်စင်နှင့်သီးခြားဝယ်ယူသုံးရသော မော်ဒယ်များကဲ့သို့ စွမ်းဆောင်ရည်မျိုး မရှိနိုင်ပါ။ ထို့အပြင် open-source မော်ဒယ်များအတွက် ငွေကြေးထောက်ပံ့မှု အကန့်အသတ်ကြောင့် ၎င်းတို့သည် ရေရှည် ထိန်းသိမ်းခြင်း မရရှိနိုင်ခြင်း သို့မဟုတ် နောက်ဆုံး သုတေသနများဖြင့် မွမ်းမံခြင်း မရနိုင်ပါ။ လူကြိုက်များသော open source မော်ဒယ်များ၏ ဥပမာများမှာ [Alpaca](https://crfm.stanford.edu/2023/03/13/alpaca.html?WT.mc_id=academic-105485-koreyst)၊ [Bloom](https://huggingface.co/bigscience/bloom) နှင့် [LLaMA](https://llama.meta.com) တို့ဖြစ်ပါသည်။

Proprietary မော်ဒယ်များသည် ကုမ္ပဏီတစ်ခု၏ ပိုင်ဆိုင်မှုဖြစ်ပြီး အများပြည်သူအတွက် ရရှိနိုင်အောင် မလုပ်ပေးထားသော မော်ဒယ်များဖြစ်ပါသည်။ ဤမော်ဒယ်များကို စီးပွားဖြစ် အသုံးပြုမှုအတွက် အကောင်းဆုံးဖြစ်စေရန် မကြာမကြာ အဆင့်မြှင့်တင်ပေးထားပါသည်။ သို့သော် ၎င်းတို့သည် စစ်ဆေးခြင်း၊ မွမ်းမံခြင်း သို့မဟုတ် မတူညီသော အသုံးပြုမှုများအတွက် စိတ်ကြိုက်ပြင်ဆင်ခြင်း မပြုလုပ်ရန် ခွင့်မပြုပါ။ ထို့အပြင် ၎င်းတို့သည် အမြဲတမ်း အခမဲ့ မရရှိနိုင်ဘဲ အသုံးပြုရန် subscription သို့မဟုတ် ဝယ်ယူရန် လိုအပ်ပါသည်။ ထို့အပြင် အသုံးပြုသူများသည် မော်ဒယ်ကို လေ့ကျင့်ရန်အတွက် အသုံးပြုသော ဒေတာများကို ထိန်းချုပ်မှု မရရှိသောကြောင့် ဒေတာ ကိုယ်ရေးကိုယ်တာ နှင့် AI ၏ တာဝန်ရှိစွာ အသုံးပြုမှုအတွက် ကတိကဝတ် သေချာစေရန် မော်ဒယ် ပိုင်ရှင်ကို ယုံကြည်ရပါသည်။ လူကြိုက်များသော proprietary မော်ဒယ်များ၏ ဥပမာများမှာ [OpenAI models](https://platform.openai.com/docs/models/overview?WT.mc_id=academic-105485-koreyst)၊ [Google Bard](https://sapling.ai/llm/bard?WT.mc_id=academic-105485-koreyst) သို့မဟုတ် [Claude 2](https://www.anthropic.com/index/claude-2?WT.mc_id=academic-105485-koreyst) တို့ဖြစ်ပါသည်။
